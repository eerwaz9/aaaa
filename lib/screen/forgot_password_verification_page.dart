        ...
        children: [
          Container(
            ...
            child: RichText(
              ...
              text: TextSpan(
                text: "ادخل رمز التحقق الذي تم ارساله الى الايميل ",
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 20,
                    fontWeight: FontWeight.bold),
                    ...
                    ..onTap = () {
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return ThemeHelper().alartDialog(" تم التحقق",
                              "تم ارسال اعادة ارسال رمز التحقق ", context);
                        },
                      );
                    },
                  style: TextStyle(
